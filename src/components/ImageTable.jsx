              ...
              <tr key={img._id}>
                <td>
                  {img.filename.match(/\.(jpg|jpeg|png|webp|gif)$/i) ? (
                    <img src={fullUrl} alt={img.filename} className="preview-image1" />
                  ) : (
                ...
                <td>
                  <button onClick={() => handleCopy(fullUrl)} className="copy-button">
                    Copy URL
                  </button>
                </td>
                <td>
                  <button onClick={() => handleDelete(img._id)} className="delete-button">
                    Delete
                  </button>
                </td>
              </tr>
